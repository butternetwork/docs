...
coverY: 0
title: Butter Network Docs — Cross-chain Routing API, Omnichain Messaging & SDK
description: Developer documentation for integrating cross-chain swaps, omnichain messaging, and routing using Butter Network’s API, SDK, and ZK light-client infrastructure.
head:
  - <meta name="keywords" content="butter network docs, cross-chain routing api, cross-chain swap api, omnichain messaging, butter sdk, zk light client, cross-chain developer docs, onchain interoperability">
layout:
  cover:
    visible: true
    size: hero
...
3. **[Cross-chain Flow & Omnichain Development](omnichain-development/cross-chain-flow.md)**

4. **[Integration Guides for APIs and smart contracts](bridge/integration.md)**
...
### **🔥 [ZK Light Client](zk-light-client/understanding-light-client.md)**
...
### **🔥 [Omnichain Development](omnichain-development/cross-chain-flow.md)**
...
### **🔥 [Omnichain Messaging Integration](omnichain-messaging/butter-omnichain-service.md)**

Guides for integrating omnichain messaging, including API usage, contracts, and deployment references.

### **🔥 [Butter Bridge & Routing Integration](bridge/integration.md)**
